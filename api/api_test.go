...
func createTestBots(mockAPI *plugintest.API, client *pluginapi.Client) *bots.MMBots {
	...
	testBots := bots.New("p2lab-agents", mockAPI, client, licenseChecker, nil, &http.Client{}, nil)
	return testBots
}
...
func SetupTestEnvironment(t *testing.T) *TestEnvironment {
	...
	api := New("p2lab-agents-test", testBots, conversationsService, nil, nil, nil, client, noopMetrics, nil, cfg, nil, nil, nil, nil, nil, nil, &mockMCPClientManager{}, nil, nil, nil)
